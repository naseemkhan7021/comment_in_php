<?php
    ...
    // hare is post table name or any table conections info
...
<body>
    ...
    <div class="container">
        <div class="bg-light p-4 my-3 text-aling-canter">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/_eYJyRK-yaY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <hr class='my-4'>
    </div>
