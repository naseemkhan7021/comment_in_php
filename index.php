...
<body>
    ...
    <!-- Hare is Quesion show   -->
    <div class="container">
        <div class="bg-light p-4 my-3 text-aling-canter" style="height: 30rem;width: 55rem;margin: auto;">
            <iframe class='h-100 w-100 container-fluid' src="https://www.youtube.com/embed/_eYJyRK-yaY" frameborder="0"
    ...
    <!-- Hare is user post his Comments, this is form for posting the comments -->
            ...
            <div class="container">
                ...
                <form class="border p-4 rounded" action="<?php $_SERVER['REQUEST_URI'] ?>" method="post">
                    <div class="mb-3">
